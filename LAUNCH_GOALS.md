...
- *(From research: GPS battery drain is a top uninstall trigger — optimize background location usage)*
...
- Must be skippable after first use — respect repeat users' time
...
- Shareable: one tap generates a clean image card with stats — native Android share sheet
...
- Live activity ticker — bottom of screen: "TrailKing92 just completed a 2.4mi walk · 3 min ago"
...
- "Someone just captured one of your hexes" — username + location
- "Your rank changed" — with delta (moved up 3 spots)
...
- **Completely free, zero paywalls** — the single biggest differentiator vs every competitor. Users cite this constantly. Structured coaching, training plans, guided runs — all free. Sets the bar for what "free" should mean.
